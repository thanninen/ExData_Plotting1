##NOTES:
##This code will create a png file called "plot4.png" to your working directory.
...
par(mfrow=c(2,2))
plot(data$DTTM,data$Global_active_power, type="l",ylab="Global Active Power",xlab="")
plot(data$DTTM,data$Voltage, type="l",ylab="Voltage",xlab="datetime")
...
plot(data$DTTM,data$Global_reactive_power, type="l",ylab="Global_reactive_power",xlab="datetime")
dev.off()